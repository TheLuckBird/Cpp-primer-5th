...
"padding: 1px 5px"));
        ...
        Jump = new QPushButton(widget_4);
        Jump->setObjectName("Jump");
        Jump->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0,1);"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/res/list.png"), QSize(), QIcon::Normal, QIcon::Off);
        Jump->setIcon(icon1);

        horizontalLayout_4->addWidget(Jump);

        World = new QPushButton(widget_4);
        World->setObjectName("World");
        World->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0,1);"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/res/world2.png"), QSize(), QIcon::Normal, QIcon::Off);
        World->setIcon(icon2);

        horizontalLayout_4->addWidget(World);
...
"color: rgb(240, 240, 240);"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lblTemp->setText(QCoreApplication::translate("MainWindow", "29\302\260", nullptr));
        ...
        Jump->setText(QString());
        World->setText(QString());
