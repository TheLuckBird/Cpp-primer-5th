...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        closebt->setGeometry(QRect(190, 200, 251, 81));
        hungry = new QPushButton(centralwidget);
        hungry->setObjectName("hungry");
        hungry->setGeometry(QRect(230, 360, 92, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        closebt->setText(QCoreApplication::translate("MainWindow", "fucking close", nullptr));
